...
class TopRatedMovieAdapter(val mDelegate:TopRatedMovieItemDelegate) : BaseAdapter<BaseViewHolder<TopRatedVO>,TopRatedVO>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<TopRatedVO> {
